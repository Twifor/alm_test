...
class SearchLiteratureTool(Tool):
    ...
    def invoke(self, invoke_data) -> Union[str, int, bool, Dict]:
        ...
        maxnum = maxnum.strip().strip("'").strip('"')
        maxnum = int(maxnum)
    ...
    def description(self) -> str:
        return "SearchLiterature(topic, maxnum, term), search for the given topic literatures in the database and return the path of literatures file and the number of literatures. the searching term should be key words in the topic (2-5 words). the number of literatures will be less than maxnum (recommend 30)."


class SplitCriteriaTool(Tool):
    def __init__(self):
        super().__init__()
    ...
    def description(self) -> str:
        return "SplitCriteria(criteria), split the screening requirements in the criteria of the literatures into a series of simple yes/no problems, and return the path of the splitted questions."


class LiteratureFilterTool(Tool):
    def __init__(self):
        super().__init__()
    ...
    def description(self) -> str:
        return "LiteratureFilter(concat_path), Check each literatures saved in the literature path according to the questions saved in the question path, and return the literatures that match the requirements. Concat path is the concatenated string of literature path and question path connected with '&&&'."


class DrawTableTool(Tool):
    def __init__(self):
        super().__init__()
    ...
    def description(self) -> str:
        return "DrawTable(literature_path_and_topic), extract the important elements of the literatures recorded in the literature path and return the path of table records. concatenate the literature path and the analysis topic with '&&&' as the input."


class CombineTableTool(Tool):
    def __init__(self):
        super().__init__()
    ...
    def description(self) -> str:
        return "CombineTable(literature_path, table_path, topic), combine several tables recorded in the table path into one comprehensive record table and return. give the literature path, table path and the exploring topic as the input."


class GenerateSummaryTool(Tool):
    def __init__(self):
        super().__init__()
    ...
    def description(self) -> str:
        return "GenerateSummary(topic, table_path), given the exploring topic and the record table path of the literatures, this tool generates a paragraph of summary."


class PrintLiteratureTool(Tool):
    def __init__(self):
        super().__init__()
    ...
    def description(self) -> str:
        return "PrintLiterature(literature_path, print_num), given the literature path and number that are required to display, this tool returns the title and abstract of the literature."


class PrintTableFileTool(Tool):
    def __init__(self):
        super().__init__()
    ...
    def description(self) -> str:
        return "PrintTableFile(table_path), given the table file path that are required to display, this tool reads the file and returns the string of the table."
